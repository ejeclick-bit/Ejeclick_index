...
const faqs = [
  {
    ...
    answer: "Nuestro proceso ágil nos permite entregar tu landing page en menos de 7 días hábiles, lista para vender y recibir pedidos en automático desde el día uno."
  },
  {
