...
const services = [
  {
    ...
    description: "Sitios web rápidos, responsivos y escalables diseñados para convertir visitantes en clientes. Optimizados con las últimas tecnologías de Silicon Valley (React, Vite, Next.js).",
    icon: Code2,
    colSpan: 2 as const,
